...
// --------------------------------------------------------------------------
void CGL_Utils::DrawCube(const Vec3D<> &Center, vfloat Dim, const Vec3D<> &Squeeze, bool Faces, bool edges, float LineWidth,
                         const CColor &Color, bool Topless)
// --------------------------------------------------------------------------
...
// --------------------------------------------------------------------------
void CGL_Utils::DrawCylinder(const Vec3D<> &v0, const Vec3D<> &v1, float Rad, float Rad2, const Vec3D<> &Squeeze, bool Faces, bool Edges,
                             float LineWidth, const CColor &Color)
// --------------------------------------------------------------------------
...
// --------------------------------------------------------------------------
void CGL_Utils::DrawCylinder(const Vec3D<> &v0, const Vec3D<> &v1, float Rad, const Vec3D<> &Squeeze, bool Faces, bool Edges,
                             float LineWidth, const CColor &Color)
// --------------------------------------------------------------------------
{ // Draw even cylinder
...
/* ---------------------------------------------------------------- */
void CGL_Utils::DrawRectangle(const Vec3D<> &Center, vfloat Dim, const Vec3D<> &Normal, const Vec3D<> &Squeeze, bool Fill, float LineWidth,
                              const CColor &Color)
/* ---------------------------------------------------------------- */
{ // draw square
    static vfloat pi = atan(1.0) * 4.0;
...
{ // draw unit sphere in Z Plane
    ...
    if (Fill) {
        ...
        glBegin(GL_TRIANGLE_FAN);
        glVertex3d(0, 0, 0);
        for (vfloat a = 0; a < pi * 2.01; a += 2 * pi / Segments) {
...
/* ---------------------------------------------------------------- */
void CGL_Utils::DrawCircle(const Vec3D<> &p, vfloat Rad, const Vec3D<> &Normal, const Vec3D<> &Squeeze, bool Fill, float LineWidth,
                           const CColor &Color)
/* ---------------------------------------------------------------- */
{
    static vfloat pi = atan(1.0) * 4.0;
...
void CGL_Utils::DrawLineArrowD(const Vec3D<> &vO, const Vec3D<> &vP, const vfloat LineWidth,
                               const CColor &Color) // draws 3D arrow Directly from vO to vP
{
    vfloat HeadPerc = 0.2;
