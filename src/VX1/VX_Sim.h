...
//	CArray3D<CVXS_Voxel*> VoxArray3; //the array of voxels
//	std::vector<CVXS_Voxel*> VoxArray1; //!< List of voxels in use
//	CArray3D<CVXS_BondInternal*> LinkArray3; //the array of voxels
//	std::vector<CVXS_BondInternal*> LinkArray1; //!< List of voxels in use
